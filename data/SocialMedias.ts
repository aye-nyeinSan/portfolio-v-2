export const socials = [
  {
    icon: "Instagram",
    href: "https://www.instagram.com/im.not_rubi",
    label: "Instagram",
  },
  {
    icon: "Linkedin",
  ...
  {
    icon: "Facebook",
    href: "https://www.facebook.com/aye.nyein.san.906527/",
    label: "Facebook",
  },
  {
    icon: "Medium",
    href: "https://medium.com/@ayenyeinsan",
    label: "Medium",
  }
];

export const iconPaths: Record<string, { viewBox: string; d: string }> = {
  Medium: {
    viewBox: "0 0 30 30",
